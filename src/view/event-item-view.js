...
import { convertToEventDateTime, convertToEventDate, convertToDateTime, convertToTime,convertToUpperCase } from '../utils.js';
...
export default class EventItemView {
  ...
  getTemplate() {
    return createEventItemTemplate(this.tripPoint);
  }
